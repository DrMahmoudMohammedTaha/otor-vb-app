...
Public Class FormSheikhDashboard
    ...
    Private Async Sub FormSheikhDashboard_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            Dim fbPath As String = System.IO.Path.Combine(Application.StartupPath, "facebook.png")
            Dim waPath As String = System.IO.Path.Combine(Application.StartupPath, "whatsapp.png")
            If System.IO.File.Exists(fbPath) Then
                picFacebook.Image = Image.FromFile(fbPath)
            End If
            If System.IO.File.Exists(waPath) Then
